...
//Globals
float hostVel; // ---- acc params
float hostVelPrev; //Host velocity in the previous time step ---- acc params
float integral = 0; //Needs to be global as it is used in the calculation of next step ---- pid params
float errorPrev = -999.0; //Previous value of PID error ---- pid params
float leadDistPrev = 0;// ---- acc params
float overshoot = 0;// ---- test/debug params 
float leadTime = 0;// ---- test/debug params
